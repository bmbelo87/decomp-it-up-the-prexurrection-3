...
| Título → música | `[0xd35eb4]` zerado em `0x402510`; init `0x410cf0` carrega tudo e espera até `0x3C0` ticks = 4,0 s (`0x4116b5`) | ~3,6 s + carga; steps carregados depois do `BGM_Play` | piso de 4,0 s desde o título; steps antes da espera (`src/loading.c`) |
